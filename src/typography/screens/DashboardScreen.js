...
export default function DashboardScreen({ navigation }) {
    ...
    const fetchStats = useCallback(async () => {
        ...
        try {
            ...
            const url = `${API_BASE}/api/security/stats`;
    ...
    const fetchReports = useCallback(async () => {
        ...
        try {
            ...
            const url = `${API_BASE}/api/security/reports`;
            const res = await fetch(url, {
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
    ...
    const markAllNotificationsRead = async () => {
        if (!token) return;
        try {
            const url = `${API_BASE}/api/notifications/read-all`;
            await fetch(url, {
                method: 'PATCH',
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const handleStartReport = async (report) => {
        ...
        try {
            const url = `${API_BASE}/api/security/report/${report._id}/start`;
            const res = await fetch(url, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
        ...
        Alert.alert(
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            const url = `${API_BASE}/api/security/report/${reportId}/resolve`;
                            const res = await fetch(url, {
                                method: 'PATCH',
                                headers: {
                                    'Content-Type': 'application/json',
    ...
    const handleSubmitReport = async () => {
        ...
        try {
            ...
            const url = `${API_BASE}/api/reporter/report`;
            const res = await fetch(url, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
