...
// // // export default function MainHomeScreen({ navigation, userName = 'Community Member' }) {
...
// // //                             <Text style={styles.statusBadgeText}>MODERATE ALERT</Text>
// // //                         </View>
// // //                         <Text style={styles.statusLocation}>📍 Lagos Island</Text>
// // //                     </View>
// // //                     <Text style={styles.statusTitle}>3 Active Incidents</Text>
// // //                     <Text style={styles.statusDesc}>Reported within a 5km radius in the last 24 hours.</Text>
// // //                 </View>
...
// // //                     </View>
// // //                     <View style={styles.reportStatBox}>
// // //                         <Text style={[styles.statCount, { color: colors.buttercup }]}>3</Text>
// // //                         <Text style={styles.statLabel}>Reviewing</Text>
// // //                     </View>
// // //                     <View style={styles.reportStatBox}>
// // //                         <Text style={[styles.statCount, { color: colors.dodgerBlue }]}>8</Text>
...
// // // Add inside fetchData or a separate useEffect
...
// //     });
// //     // Use district, subregion, or city — whichever is most specific
// //     const areaName = place.district || place.subregion || place.city || 'Your Area';
...
// //             // 2. My report analytics → /api/reporter/analytics
// //             //    Gives: total, pending, underReview, inProgress, assigned, resolved
// //             const analyticsRes = await fetch(API.REPORTER_ANALYTICS, { headers });
// //             if (analyticsRes.ok) {
// //                 const analyticsData = await analyticsRes.json();
// //                 setAnalytics(analyticsData);
// //             }

// //             // 3. Community watch → /api/reporter/community-watch
// //             //    Returns all active reports — we show the count as "Active Incidents"
// //             const communityRes = await fetch(API.COMMUNITY_WATCH, { headers });
// //             if (communityRes.ok) {
...
// //                                 {communityCount !== null ? `${communityCount} Active Incident${communityCount !== 1 ? 's' : ''}` : '— Active Incidents'}
// //                             </Text>
// //                             <Text style={styles.statusDesc}>Reported within a 5km radius in the last 24 hours.</Text>
// //                         </>
// //                     )}
...
//             //    Pass coords so backend filters to 5km radius.
//             //    Falls back to all reports if location was denied.
//             const communityUrl =
//                 latitude !== null && longitude !== null
//                     ? `${API.COMMUNITY_WATCH}?lat=${latitude}&lng=${longitude}`
//                     : API.COMMUNITY_WATCH;
