...
// //     vandalism: 'other',         // backend has no vandalism — closest is other
// //     accident: 'accident',
// //     medical: 'other',           // backend has no medical — closest is other
// //     fire: 'fire',
// //     other: 'other',
// // };

// // // ── Map UI incident type → backend type enum (crime/incident/emergency) ───────
// // const TYPE_MAP = {
// //     theft: 'crime',
// //     assault: 'crime',
// //     suspicious: 'crime',
...
// //             setLocationSecondary('Tap "Edit Location" to retry');
...
// //                 suspectsCount: suspects ? parseInt(suspects) || 0 : undefined,
// //                 weapons: weapons || undefined,
// //                 vehicles: vehicle || undefined,
// //                 // NOTE: 'isAnonymous' is not yet supported by the backend Report model.
// //                 // Add an isAnonymous boolean field to Report.js to enable this feature.
...
// //             // Success — move to the success screen
// //             setStep(6);
...
// //             {/* NOTE: File upload (photos/videos) is not yet supported by the backend.
// //                 The backend needs multer + cloud storage (e.g. Cloudinary or AWS S3)
// //                 to handle file uploads. This button is non-functional until then. */}
// //             <Text style={[styles.sectionTitle, { marginTop: 24 }]}>Evidence (Optional)</Text>
// //             <TouchableOpacity style={styles.uploadBox} activeOpacity={0.8}>
// //                 <Text style={styles.uploadIcon}>📷</Text>
// //                 <Text style={styles.uploadText}>Tap to upload photos or videos</Text>
...
//     // ── Pick evidence files from media library ────────────────────────────────
...
//                     });
//                 });
//                 await fetch(`${API.CREATE_REPORT}/${data._id}/evidence`, {
//                     method: 'POST',
...
export default function ReportIncidentScreen({ navigation }) {
    ...
    const submitReport = async () => {
        ...
        try {
            ...
            console.log('[ReportIncident] POST →', API.CREATE_REPORT);
            ...
            if (evidenceFiles.length > 0 && reportId) {
                try {
                    ...
                    const evidenceUrl = `${API.CREATE_REPORT}/${reportId}/evidence`;
