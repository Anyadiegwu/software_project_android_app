...
// //     // ── Fetch reports ───────────────────────────────────────────────────────
// //     const fetchReports = useCallback(async function() {
// //         if (!token) return;
// //         try {
...
// //     // ── Start report ────────────────────────────────────────────────────────
// //     const handleStartReport = async function(reportId) {
// //         if (!token) return;
// //         try {
...
// //     // ── Resolve report ──────────────────────────────────────────────────────
// //     const handleResolveReport = async function(reportId) {
// //         if (!token) return;
// //         try {
// //             const res = await fetch(API_BASE + '/api/security/report/' + reportId + '/resolve', {
// //                 method: 'PATCH',
// //                 headers: {
// //                     'Content-Type': 'application/json',
// //                     Authorization: 'Bearer ' + token,
...
// //     useEffect(function() {
// //         (async function() {
// //             const statusResult = await Location.requestForegroundPermissionsAsync();
// //             if (statusResult.status !== 'granted') return;
// //             const initial = await Location.getCurrentPositionAsync({ accuracy: Location.Accuracy.Balanced });
// //             try {
// //                 const geo = await Location.reverseGeocodeAsync({
// //                     latitude: initial.coords.latitude,
...
// //     // ── User profile ────────────────────────────────────────────────────────
// //     useEffect(function() {
// //         loadUserProfile().then(function(profile) {
...
// //     // ── Live counter ────────────────────────────────────────────────────────
// //     useEffect(function() {
// //         let t = setInterval(function() { setLiveCounter(function(s) { return s + 1; }); }, 1000);
...
// //             Animated.timing(slideAnim, { toValue: -drawerWidth, duration: 250, useNativeDriver: true }),
// //             Animated.timing(fadeAnim, { toValue: 0, duration: 250, useNativeDriver: true }),
// //         ]).start(function() { setIsDrawerOpen(false); });
// //     };
...
// //                             <ScrollView style={styles.drawerMenu} showsVerticalScrollIndicator={false}>
// //                                 <Text style={styles.drawerSectionLabel}>OPERATIONS</Text>
// //                                 <TouchableOpacity style={[styles.drawerMenuItem, activeTab === 'dashboard' && styles.drawerMenuItemActive]} onPress={function() { setActiveTab('dashboard'); closeDrawer(); }}>
// //                                     <Ionicons name="home" size={22} color="#F59E0B" />
// //                                     <Text style={[styles.drawerMenuText, activeTab === 'dashboard' && styles.drawerMenuTextActive]}>Home</Text>
// //                                 </TouchableOpacity>
// //                                 <TouchableOpacity style={[styles.drawerMenuItem, activeTab === 'cases' && styles.drawerMenuItemActive]} onPress={function() { setActiveTab('cases'); closeDrawer(); }}>
// //                                     <Ionicons name="document-text-outline" size={22} color="#F59E0B" />
// //                                     <Text style={[styles.drawerMenuText, activeTab === 'cases' && styles.drawerMenuTextActive]}>Active Cases</Text>
// //                                 </TouchableOpacity>
// //                                 <TouchableOpacity style={[styles.drawerMenuItem, activeTab === 'map' && styles.drawerMenuItemActive]} onPress={function() { setActiveTab('map'); closeDrawer(); }}>
// //                                     <Ionicons name="map-outline" size={22} color="#F59E0B" />
// //                                     <Text style={[styles.drawerMenuText, activeTab === 'map' && styles.drawerMenuTextActive]}>Live Incident Map</Text>
// //                                 </TouchableOpacity>
// //                             </ScrollView>
// //                             <View style={styles.drawerFooter}>
// //                                 <View style={styles.drawerDivider} />
// //                                 <TouchableOpacity style={styles.drawerSignOut} onPress={async function() { closeDrawer(); await clearUserSession(); navigation.navigate('Home'); }}>
// //                                     <CustomSignOutIcon color="#F59E0B" />
// //                                     <Text style={styles.drawerSignOutText}>Sign Out</Text>
// //                                 </TouchableOpacity>
// //                                 <Text style={styles.drawerVersion}>Aegis v2.4.4  ·  {currentLocation}</Text>
...
// //                         {/* Top Navigation Bar */}
// //                         <View style={styles.topBar}>
// //                             <TouchableOpacity style={styles.iconButton} onPress={function() { setIsDrawerOpen(true); }}>
// //                                 <MenuIcon color="#9CA3AF" />
// //                             </TouchableOpacity>
// //                             <View style={styles.logoContainer}>
// //                                 <View style={styles.logoBox}>
...
// //                             {/* Command Status Card */}
// //                             <LinearGradient colors={['#16284B', '#0A0F1E']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.commandStatusCard}>
// //                                 <View style={styles.commandCardHeader}>
// //                                     <View>
// //                                         <Text style={styles.commandCardLabel}>COMMAND STATUS - {currentLocation}</Text>
// //                                         {loadingStats ? (
...
// //                                                 <Text style={styles.reportsSubtext}>{dashboardStats.active} active cases • {dashboardStats.resolved} resolved</Text>
// //                                             </>
// //                                         )}
// //                                     </View>
// //                                     <CarIcon size={32} color="#F59E0B" />
...
// //                             <View style={styles.sectionHeader}>
// //                                 <Text style={styles.sectionTitle}>{"TODAY'S OVERVIEW"}</Text>
// //                                 <TouchableOpacity onPress={function() { setActiveTab('cases'); }}>
// //                                     <Text style={styles.fullStatsText}>Full stats →</Text>
// //                                 </TouchableOpacity>
// //                             </View>
...
// //                                     ) : (
// //                                         <Text style={[styles.statNumber, { color: colors.dodgerBlue }]}>{dashboardStats.pending}</Text>
// //                                     )}
...
// //                                     ) : (
// //                                         <Text style={[styles.statNumber, { color: '#F59E0B' }]}>{dashboardStats.active}</Text>
// //                                     )}
// //                                     <Text style={styles.statLabel}>Active Cases</Text>
// //                                 </View>
// //                                 <View style={styles.statCard}>
...
// //                                     ) : (
// //                                         <Text style={[styles.statNumber, { color: colors.caribbeanGreen }]}>{dashboardStats.resolved}</Text>
// //                                     )}
...
// //                             {/* Map Preview */}
// //                             <TouchableOpacity style={styles.mapPreviewCard} activeOpacity={0.9} onPress={function() { setActiveTab('map'); }}>
// //                                 <MapView
// //                                     style={StyleSheet.absoluteFillObject}
// //                                     provider={PROVIDER_DEFAULT}
// //                                     initialRegion={MINI_MAP_REGION}
...
// //                             ) : reports.length === 0 ? (
// //                                 <View style={styles.reportCard}>
// //                                     <Text style={styles.reportTitle}>No assigned cases yet.</Text>
// //                                 </View>
// //                             ) : (
// //                                 reports.slice(0, 3).map(function(report) {
// //                                     return (
// //                                         <View key={report._id} style={styles.caseCard}>
// //                                             <View style={styles.caseHeader}>
// //                                                 <View style={[styles.priorityBadge, { backgroundColor: report.urgency === 'critical' || report.urgency === 'high' ? 'rgba(239, 68, 68, 0.1)' : 'rgba(245, 158, 11, 0.1)' }]}>
// //                                                     <Text style={[styles.priorityBadgeText, { color: report.urgency === 'critical' || report.urgency === 'high' ? '#EF4444' : '#F59E0B' }]}>
// //                                                         {priorityFromUrgency(report.urgency)}
// //                                                     </Text>
// //                                                 </View>
// //                                                 <Text style={styles.caseTitle} numberOfLines={2}>{report.description || report.category || 'Report'}</Text>
// //                                             </View>
// //                                             <Text style={styles.caseMeta}>Status: {statusLabel(report.status)}  ·  {timeAgo(report.createdAt)}</Text>
// //                                             <View style={styles.caseFooter}>
// //                                                 <Text style={styles.unassignedText}>{statusLabel(report.status)}</Text>
// //                                                 {report.status === 'assigned' ? (
// //                                                     <TouchableOpacity style={styles.actionButton} onPress={function() { handleStartReport(report._id); }}>
// //                                                         <Text style={styles.actionButtonText}>START</Text>
// //                                                     </TouchableOpacity>
// //                                                 ) : null}
// //                                                 {report.status === 'in_progress' ? (
// //                                                     <TouchableOpacity style={styles.outlineButton} onPress={function() { handleResolveReport(report._id); }}>
...
// //                     <ScrollView style={styles.mainScroll} showsVerticalScrollIndicator={false}>
// //                         <View style={styles.casesHeaderContainer}>
// //                             <TouchableOpacity onPress={function() { setActiveTab('dashboard'); }} style={styles.casesBackBtn}>
// //                                 <Ionicons name="arrow-back" size={20} color="#9CA3AF" />
// //                             </TouchableOpacity>
...
// //                         <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.casesFilters} contentContainerStyle={{ paddingRight: 20 }}>
// //                             {['ALL', 'ASSIGNED', 'IN PROGRESS', 'RESOLVED'].map(function(f) {
// //                                 return (
// //                                     <TouchableOpacity
// //                                         key={f}
// //                                         style={[styles.filterChip, caseFilter === f && styles.filterChipActive]}
// //                                         onPress={function() { setCaseFilter(f); }}
// //                                     >
...
// //                                                     </Text>
// //                                                 </View>
// //                                                 <Text style={styles.casesCardTitle} numberOfLines={2}>{report.description || report.category || 'Report'}</Text>
// //                                             </View>
// //                                             <Text style={styles.casesCardMeta}>Status: {statusLabel(report.status)}  ·  {timeAgo(report.createdAt)}</Text>
...
// //                                                 <Text style={styles.unassignedText}>{statusLabel(report.status)}</Text>
// //                                                 {report.status === 'assigned' ? (
// //                                                     <TouchableOpacity style={styles.assignButton} onPress={function() { handleStartReport(report._id); }}>
...
// //                 ) : activeTab === 'map' ? (
// //                     <View style={{ flex: 1 }}>
// //                         <OfficerMapView onBack={function() { setActiveTab('dashboard'); }} />
// //                     </View>
// //                 ) : null}

// //                 {/* Bottom Navigation */}
// //                 <View style={[styles.bottomNav, { paddingBottom: Math.max(insets.bottom, 12), height: 64 + Math.max(insets.bottom, 12) }]}>
// //                     <TouchableOpacity style={styles.navItem} onPress={function() { setActiveTab('dashboard'); }}>
// //                         <View style={styles.navIconContainer}>
// //                             <HomeIcon color={activeTab === 'dashboard' ? "#F59E0B" : "#6B7280"} />
// //                         </View>
// //                         <Text style={activeTab === 'dashboard' ? styles.navLabelActive : styles.navLabel}>DASHBOARD</Text>
// //                     </TouchableOpacity>
// //                     <TouchableOpacity style={styles.navItem} onPress={function() { setActiveTab('cases'); }}>
// //                         <View style={styles.navIconContainer}>
// //                             <ClipboardIcon color={activeTab === 'cases' ? "#F59E0B" : "#6B7280"} />
// //                         </View>
// //                         <Text style={activeTab === 'cases' ? styles.navLabelActive : styles.navLabel}>CASES</Text>
// //                     </TouchableOpacity>
// //                     <TouchableOpacity style={styles.navItem} onPress={function() { setActiveTab('map'); }}>
// //                         <View style={styles.navIconContainer}>
// //                             <MapIcon color={activeTab === 'map' ? '#F59E0B' : '#6B7280'} />
// //                         </View>
// //                         <Text style={activeTab === 'map' ? styles.navLabelActive : styles.navLabel}>MAP</Text>
...
export default function DashboardScreen({ navigation }) {
    ...
    const handleSubmitReport = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE}/api/reporter/report`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
