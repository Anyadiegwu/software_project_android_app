...
//   { id: 'patrols',  label: 'PATROLS',   color: '#4A90E2' },
// ];

// const DEFAULT_REGION: Region = {
//   latitude: 9.0765,   // Abuja, Nigeria fallback
//   longitude: 7.3986,
...
// const MOCK_PINS = [
//   { id: 1, latitude: 9.0800, longitude: 7.3950, type: 'alerts',   icon: '⚠️', color: '#FFB347' },
//   { id: 2, latitude: 9.0720, longitude: 7.4010, type: 'high_risk',icon: '🔫', color: '#FF4B4B' },
//   { id: 3, latitude: 9.0780, longitude: 7.4050, type: 'resolved', icon: '✅', color: '#45D0B1' },
//   { id: 4, latitude: 9.0700, longitude: 7.3900, type: 'patrols',  icon: '🛡️', color: '#4A90E2' },
//   { id: 5, latitude: 9.0850, longitude: 7.3990, type: 'alerts',   icon: '⚠️', color: '#FFB347' },
// ];
...
//       // Get an immediate fix and animate to it
...
//           <Text style={styles.liveText}>Live · 5 incidents</Text>
//         </View>
//       </View>
//     </SafeAreaView>
//   );
...
export default function MapTab() {
  ...
  const fetchPins = useCallback(async () => {
    ...
    try {
      ...
      let url = `${API_BASE}/api/reporter/safety-map`;
      if (userLocation) {
